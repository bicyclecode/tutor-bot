...
book = os.path.join(dirname, u'bottext.txt')
...
cons_key = 'wnni5lKAMY2gBzktYbqIr09IL'
# Consumer Secret (API Secret)
cons_secret = 'gCqKUSKkFjuVXJZTtZR1Avr7BIG3fm8LKwlPDuFmVVf6iO2zIF'
# Access Token
access_token = '857178351177531392-yiW0fjWnoVHbOqteUICL4BlHm7QogAb'
# Access Token Secret
access_token_secret = 'n9FXiYJZCMuMRY07AyhbVX2qjhfB6mXodI3qhmjo5P0Al'
...
# This function operates in a Thread in the background, so your code will not
# block by calling it.
#tweetbot.twitter_tweeting_start(days=0, hours=0, minutes=0.5, keywords=None, prefix=None, suffix='#RealBest')
